...
<!-- CREAR -->
	...
	<div align="center">
		<input type="button" value="${create}"
			onclick="javascript: window.location.href = './endorserRecord/ranger/create.do?curriculumId=${curriculumId}';" /></div>


<display:table name="records" id="row"
	requestURI="${requestURI}" pagesize="4" class="displaytag">
	
	<spring:message code="personalRecord.fullName" var="name"></spring:message>
	...
	<display:column property="linkedProfile" title="${linkedProfile}"></display:column>
...
<!-- EDITAR -->
	...
	<display:column title="${edit}">
		<input type="button" value="${edit}"
			onclick="javascript: window.location.href = './endorserRecord/ranger/edit.do?endorserRecordId=${row.id}';" />
	</display:column>
