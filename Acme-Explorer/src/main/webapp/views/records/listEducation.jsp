...
<!-- CREAR -->
	...
	<div align="center">
		<input type="button" value="${create}"
			onclick="javascript: window.location.href = './educationRecord/ranger/create.do?curriculumId=${curriculumId}';" /></div>


<display:table name="records" id="row"
	requestURI="${requestURI}" pagesize="4" class="displaytag">

<spring:message code="educationRecord.title" var="title"></spring:message>
...
<spring:message code="general.attachment" var="attachment"></spring:message>
	...
	<display:column property="institution" title="${institution}"></display:column>
...
<!-- EDITAR -->
	...
	<display:column title="${edit}">
		<input type="button" value="${edit}"
			onclick="javascript: window.location.href = './educationRecord/ranger/edit.do?educationRecordId=${row.id}';" />
	</display:column>
